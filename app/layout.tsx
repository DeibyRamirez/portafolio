...
export const metadata: Metadata = {
  ...
  description: "Ingeniero de Software y Computación | Desarrollo Web y Móvil",
};
        ...
        <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-sm">
          <div className="container mx-auto px-6 py-4">
            <nav className="flex justify-between items-center">
              <div className="text-xl font-bold text-gray-800">Deiby<span className="text-yellow-500">Ramirez</span></div>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <h2 className="text-2xl font-bold">Deiby Ramirez</h2>
                <p className="text-gray-400">Ingeniero de Software y Computación</p>
              </div>
              <div className="flex space-x-6">
                {/* Acceso a redes sociales Navegacion para arriba automatica */}
            ...
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
              <p>© {new Date().getFullYear()} Portafolio Deiby Alejandro Ramirez Galvis. Todos los derechos reservados.</p>
            </div>
          </div>
        </footer>
      </body>
