...
export default function Inicio() {
    return (
        <section id="inicio" className="w-full h-200 bg-gray-700 flex">
            ...
            <div className="w-7xl h-200 flex flex-col">
                ...
                <div className="m-4 shadow-lg shadow-black border rounded-4xl flex-40 flex flex-col items-start justify-center text-left p-6 relative overflow-hidden">
                    <Image
                        src="/fondo_1.jpg"
                        alt="Fondo 1"
                        width={600}
                    ...
                    <div className="relative z-10 w-full">
                        ...
                        <select
                            id="contacto"
                            className="mt-4 p-2 rounded-lg bg-red-500  border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500  text-white"
                            defaultValue=""
                        >
