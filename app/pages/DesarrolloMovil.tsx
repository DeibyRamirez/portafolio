...
interface DesarrolloMovilProps {
  proyectos: DesarrolloInterface[];
}

function DesarrolloMovilContenido() {
    ...
    <div className="flex flex-col lg:flex-row gap-10 items-center">
      <div className="relative w-full lg:w-1/3 flex justify-center">
        <div className="relative w-70 h-auto group">
          <Image src="/celular.png" alt="Telefono" width={300} height={600} className="z-0" />
          <div className="absolute top-[3.5%] left-[8%] w-[84%] h-[92.5%] bg-white rounded-2xl overflow-hidden shadow-xl">
            {proyecto ? (
              ...
              <div className="h-full flex items-center justify-center text-gray-500 text-sm px-4 text-center">
                No hay proyectos móviles disponibles.
              </div>
            )}
          </div>
        </div>
...
export default function DesarrolloMovil({ proyectos }: DesarrolloMovilProps) {
  return (
    <section id="d_movil" className="px-6 py-20 md:px-8">
      <div className="section-shell mx-auto max-w-6xl rounded-3xl p-8 md:p-10">
        ...
        <ContenedorProyectoCategoria proyectos={proyectos} tipo="movil">
          <DesarrolloMovilContenido />
